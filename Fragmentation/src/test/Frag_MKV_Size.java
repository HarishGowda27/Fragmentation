...
public class Frag_MKV_Size {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/Size_mkv_HD.mkv");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/Size_mkv_PAL.mkv");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/Size_mkv_NTSC.mkv");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/Size_mkv_P2P.mkv");
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_mkv_Versa_Size");
