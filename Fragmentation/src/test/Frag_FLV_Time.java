...
public class Frag_FLV_Time {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/time_flv_HD.flv");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/time_flv_PAL.flv");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/time_flv_NTSC.flv");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/time_flv_P2P.flv");
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_FLV_Versa_time");
