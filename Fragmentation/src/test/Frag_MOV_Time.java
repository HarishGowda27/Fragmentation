...
public class Frag_MOV_Time {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/Time_mov_HD.mov");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/Time_mov_PAL.mov");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/Time_mov_NTSC.mov");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/Time_mov_P2P.mov");
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_Mov_Versa_Time");
