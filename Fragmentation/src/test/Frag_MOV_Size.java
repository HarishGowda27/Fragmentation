...
public class Frag_MOV_Size {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/Size_mov_HD.mov");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/Size_mov_PAL.mov");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/Size_mov_NTSC.mov");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/Size_mov_P2P.mov");
	
	//muxer 
	PageLocators.muxer_mov(driver).click();
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_Mov_Versa_Size");
