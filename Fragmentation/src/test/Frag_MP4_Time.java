...
public class Frag_MP4_Time {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/Time_mp4_HD.mp4");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/Time_mp4_PAL.mp4");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/Time_mp4_NTSC.mp4");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/Time_mp4_P2P.mp4");
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_mp4_Versa_Time");
