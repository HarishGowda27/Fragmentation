...
public class Frag_MOV_Clock {
	...
	//pro1_HD
	PageLocators.mp4_pro1_path(driver).sendKeys("device/Statix_Folder/Clock_mov_HD.mov");
	//pro2_PAL
	PageLocators.mp4_pro2_path(driver).sendKeys("device/Statix_Folder/Clock_mov_PAL.mov");
	//pro3_PAL
	PageLocators.mp4_pro3_path(driver).sendKeys("device/Statix_Folder/Clock_mov_NTSC.mov");
	//pro3_PAL
	PageLocators.mp4_pro4_path(driver).sendKeys("device/Statix_Folder/Clock_mov_P2P.mov");
	...
	PageLocators.Job_Name(driver).sendKeys("_Frag_Mov_Versa_Clock");
