...
public class Frag_TS_Size_Versa {
		...
		//pro1 HD
		PageLocators.File_stream_path_HD(driver).sendKeys("device/Statix_Folder/hd_SIZE.ts");
		...
		PageLocators.File_stream_path_PAL(driver).sendKeys("device/Statix_Folder/pal_SIZE.ts");
		...
		PageLocators.File_stream_path_NTSC(driver).sendKeys("device/Statix_Folder/ntsc_SIZE.ts");
		...
		PageLocators.File_stream_path_P2P(driver).sendKeys("device/Statix_Folder/p2p_SIZE.ts");
		...
		PageLocators.File_stream_path_Bcast(driver).sendKeys("device/Statix_Folder/Bcast_SIZE.ts");
		...
		PageLocators.Job_Slicing_Size(driver);
		
		PageLocators.Add_output(driver).click();
		
		PageLocators.Job_Name(driver).sendKeys("_Frag_TS_Versa_Size");
