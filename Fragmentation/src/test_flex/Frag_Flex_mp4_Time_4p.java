...
public class Frag_Flex_mp4_Time_4p {
	...
	public static void start() throws InterruptedException  {
		...
		PageLocatorsflex.Job_Name(driver).sendKeys("Frag_4p_mp4_Time");
		...
		PageLocatorsflex.Ouput_Storage_path_HD(driver).sendKeys("device/Statix_Folder/Frag_Time_HD_MP4.mp4");
		
		PageLocatorsflex.Scroll_page(driver);
		
		PageLocatorsflex.Ouput_Storage_path_NTSC(driver).sendKeys("device/Statix_Folder/Frag_Time_NTSC_MP4.mp4");
		
		PageLocatorsflex.Ouput_Storage_path_PAL(driver).sendKeys("device/Statix_Folder/Frag_Time_PAL_MP4.mp4");
		
		PageLocatorsflex.Ouput_Storage_path_P2P(driver).sendKeys("device/Statix_Folder/Frag_Time_P2P_MP4.mp4");
		
		PageLocatorsflex.Scroll_page(driver);
		
		PageLocatorsflex.Slice_Time(driver);
